		...
		return (
			<div className="container">
                ...
                <div style={{display: this.state.step == 2 ? 'block' : 'none' }}>
                    ...
                    <button onClick={this.previousStep.bind(this)} className="btn btn-primary">Previous</button>
                    <button onClick={this.nextStep.bind(this)}  className="btn btn-primary">Next</button>
                </div>
                ...
                <div style={{display: this.state.step == 3 ? 'block' : 'none' }}>
                    ...
                    <button  onClick={this.previousStep.bind(this)} className="btn btn-primary">Previous</button>
                    <button  onClick={this.checkAndSubmit.bind(this)} className="btn btn-success ">Submit</button>
                </div>
